...
allFruits.forEach (toLowerCase);

// Convert all fruits name into lowercase and store in new array named lowercaseFruits
function lowerCaseFruits(element) {
    let lowerCaseFruits = [];
    lowerCaseFruits.push (element.toLowerCase());
    console.log(lowerCaseFruits);
}
allFruits.forEach(lowerCaseFruits);

// Convert all fruits name into uppercase and store in new array named uppercaseFruits
function uppercaseFruits (element) {
    let uppercaseFruits = [];
    uppercaseFruits.push (element.toUpperCase());
    console.log(uppercaseFruits);
}
allFruits.forEach(uppercaseFruits);
